...
console.log(`(manager_calendarJS)The current user is: ${currentUser.username} and their role is: ${currentUser.accountType} session: ${currentUser.sessionId}`);
...
console.log(`(manager_calendarJS)The logged in name is: ${loggedName}`);
// Set the name header to the logged in user
managerNameHeader.innerHTML = loggedName;
