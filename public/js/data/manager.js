...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!session) {
        console.warn("(manager.js) No session found. Redirecting to login.");
    ...
    console.log(`(manager.js) Logged in as ${fullName}, role: ${role}`);

    // Populate headers
    document.getElementById('manager_name').textContent = fullName;
